...
function preload()
{
  ...
  emptyImg= loadAnimation("empty.png");
  oneStarImg= loadAnimation("one_star.png")
  fullImg= loadAnimation("stars.png")
...
function setup() 
{
  ...
  score.scale=0.2
  score.addAnimation("empty", emptyImg)
  score.addAnimation("oneStar", oneStarImg)
  score.addAnimation("full", fullImg)
...
function draw() 
{
  ...
  if (collide(fruit, star1, 20)==true){
    score.changeAnimation("oneStar")
    star1.visible=false;
  }
  
  if (collide(fruit, star2, 20)==true&&star1.visible==false){
    score.changeAnimation("full")
    star2.visible=false;
  }
  else if(collide(fruit, star2, 20)==true){
    score.changeAnimation("oneStar")
    star2.visible=false;
  }
